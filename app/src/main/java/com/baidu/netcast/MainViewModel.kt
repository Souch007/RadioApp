...
import com.baidu.netcast.ui.favourites.adapters.OnFavouriteClickListener
import com.baidu.netcast.ui.podcast.PodcastViewModel
import com.baidu.netcast.ui.podcast.adapter.OnClickListenerPodcast
import com.baidu.netcast.ui.podcast.poddata.PodListData
import com.baidu.netcast.ui.radio.FilterSearchListener
import com.baidu.netcast.ui.radio.RadioViewModel
import com.baidu.netcast.ui.radio.adapter.OnAllRecentPlayerClickListener
...
import com.baidu.netcast.ui.seeall.adapter.OnClickListenerSeeAll
import com.baidu.netcast.ui.seeall.adapter.OnClickListerPODSeeAll
...
//        AppSingelton.favouritesRadioArray=updatedList
    ...
    override fun onLanguageClicked(data: com.baidu.netcast.ui.radio.lanuages.Data) {
        _queriedSearched.value = data.name
    }

    override fun onSearchTagClicked(data: com.baidu.netcast.ui.search.frequentsearch.Data) {
