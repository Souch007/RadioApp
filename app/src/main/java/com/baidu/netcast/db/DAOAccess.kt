...
interface DAOAccess {
    ...
    @Insert(onConflict = OnConflictStrategy.REPLACE)
    suspend fun insertRadioStations(data :com.baidu.netcast.ui.radio.data.temp.Data)

    @Query("SELECT * FROM RadioStations")
    fun getRadioData(): com.baidu.netcast.ui.radio.data.temp.Data

    @Insert(onConflict = OnConflictStrategy.REPLACE)
    suspend fun insertPodCast(data :com.baidu.netcast.ui.podcast.poddata.Data)

    @Query("SELECT * FROM PodStations")
    fun getPodData(): com.baidu.netcast.ui.podcast.poddata.Data?
