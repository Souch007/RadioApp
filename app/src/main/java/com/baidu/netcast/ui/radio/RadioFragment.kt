...
import com.baidu.netcast.databinding.FragmentRadioBinding
import com.baidu.netcast.db.AppDatabase
import com.baidu.netcast.request.Resource
import com.baidu.netcast.ui.favourites.adapters.FavouriteAdapter
            ...
            try {
                when (it) {
                        ...
                        CoroutineScope(Dispatchers.IO).launch {
                            ...
                            withContext(Dispatchers.Main) {
                                try {
                                    ...
                                    binding.adapter =
                                        com.baidu.netcast.ui.radio.adapter.RadioFragmentAdapter(
                                            listOf(),
                    ...
                    is Resource.Success -> {
                        ...
                        AppSingelton.publicList = data.pop
                        binding.adapter = com.baidu.netcast.ui.radio.adapter.RadioFragmentAdapter(
                            listOf(),
                            mainActivityViewModel,
                            "public"
                        )
        ...
        radioViewModel.countriesListingLive.observe(viewLifecycleOwner) {
            try {
                ...
                binding.countriesAdapter =
                    com.baidu.netcast.ui.radio.adapter.CountriesAdapter(
                        listOf(),
                        mainActivityViewModel,
                        "limited"
                    )
