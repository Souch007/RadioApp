...
import com.baidu.netcast.ui.radio.adapter.RadioFragmentAdapter
...
import com.baidu.netcast.util.ConnectivityChecker
...
//        requestPermission()
        ...
        dataBinding.icPlay.setOnClickListener {
            if (dataBinding.playerView.player?.isPlaying == true) {
                ...
                dataBinding.icPlay.setImageResource(R.drawable.play_button)
            } else {
                dataBinding.playerView.player?.play()
                dataBinding.icPlay.setImageResource(R.drawable.pause_button)
            }
...
//            dataBinding.radioSuggestion.visibility = View.GONE
            ...
            dataBinding.adapter = RadioFragmentAdapter(
