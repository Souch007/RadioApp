...
import com.netcast.baidutv.databinding.FragmentRadioBinding
import com.netcast.baidutv.db.AppDatabase
import com.netcast.baidutv.request.Resource
import com.netcast.baidutv.ui.favourites.adapters.FavouriteAdapter
            ...
            try {
                when (it) {
                    is Resource.Failure -> {
                        CoroutineScope(Dispatchers.IO).launch {
                            ...
                            withContext(Dispatchers.Main) {
                                ...
                                binding.adapter =
                                    com.netcast.baidutv.ui.radio.adapter.RadioFragmentAdapter(
                                        listOf(),
                    ...
                    is Resource.Success -> {
                        ...
                        AppSingelton.publicList = data.pop
                        binding.adapter = com.netcast.baidutv.ui.radio.adapter.RadioFragmentAdapter(
                            listOf(),
                            mainActivityViewModel,
                            "public"
                        )
        ...
        radioViewModel.languagesListingLive.observe(viewLifecycleOwner) {
            try {
                ...
                binding.languagesAdapter =
                    com.netcast.baidutv.ui.radio.adapter.LanguagesAdapter(
                        listOf(),
                        mainActivityViewModel,
                        "limited"
                    )
        ...
        radioViewModel.countriesListingLive.observe(viewLifecycleOwner) {
            try {
                ...
                binding.countriesAdapter =
                    com.netcast.baidutv.ui.radio.adapter.CountriesAdapter(
                        listOf(),
                        mainActivityViewModel,
                        "limited"
                    )
