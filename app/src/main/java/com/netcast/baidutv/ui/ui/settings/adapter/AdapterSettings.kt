...
import com.netcast.baidutv.ui.ui.settings.SettingsData

class AdapterSettings(private val mSettingsList: MutableLiveData<ArrayList<SettingsData>>?) :
    RecyclerView.Adapter<AdapterSettings.MyViewHodler>() {
