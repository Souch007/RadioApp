package com.netcast.baidutv.ui.radioplayermanager
...
import com.netcast.baidutv.databinding.ActivityRadioPlayerBinding
...
import com.netcast.baidutv.ui.radioplayermanager.adapter.PodEpisodesAdapter
import com.netcast.baidutv.ui.radioplayermanager.episodedata.Data
import com.netcast.baidutv.ui.ui.settings.AlarmFragment
import com.netcast.baidutv.ui.ui.settings.SleepTimerFragment
import com.netcast.baidutv.util.BottomSheetOptionsFragment
import com.netcast.baidutv.util.OptionsClickListner
...
//        requestPermission()
        ...
        dataBinding.icPlay.setOnClickListener {
            if (dataBinding.playerView.player?.isPlaying == true) {
                ...
                dataBinding.icPlay.setImageResource(com.netcast.baidutv.R.drawable.play_button)
            } else {
                dataBinding.playerView.player?.play()
                dataBinding.icPlay.setImageResource(com.netcast.baidutv.R.drawable.pause_button)
            }
...
//        if (checkWifiPlaySettings()) {
    ...
    private fun uiControls() {
        ...
        Glide.with(dataBinding.ivChannelLogo.context)
            ...
            .error(com.netcast.baidutv.R.drawable.logo).diskCacheStrategy(DiskCacheStrategy.ALL)
...
//            dataBinding.radioSuggestion.visibility = View.GONE
            ...
            dataBinding.adapter = com.netcast.baidutv.ui.radio.adapter.RadioFragmentAdapter(
    ...
    override val layoutRes: Int
        get() = com.netcast.baidutv.R.layout.activity_radio_player
