...
import com.netcast.baidutv.ui.radio.genres.Genres
...
import com.netcast.baidutv.ui.radio.countries.Countries
import com.netcast.baidutv.ui.radio.data.temp.RadioLists
import com.netcast.baidutv.ui.radio.data.temp.RadioResponse
import com.netcast.baidutv.ui.radio.lanuages.Data
import com.netcast.baidutv.ui.radio.lanuages.Lanuages
...
class RadioViewModel() : ViewModel() , OnClickListnerRadio , OnClickListenerLanguages,OnClickListenerCountires , OnClickGeneresListener{
    ...
    val _countriesListArray = MutableLiveData<List<com.netcast.baidutv.ui.radio.countries.Data>>()
    val countriesListArray : LiveData<List<com.netcast.baidutv.ui.radio.countries.Data>> = _countriesListArray
    ...
    val _genresListArray = MutableLiveData<List<com.netcast.baidutv.ui.radio.genres.Data>>()
    val genresListArray : LiveData<List<com.netcast.baidutv.ui.radio.genres.Data>> = _genresListArray
    ...
    override fun OnCountrlySelected(data: com.netcast.baidutv.ui.radio.countries.Data) {
    }
